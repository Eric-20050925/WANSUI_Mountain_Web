...
const totalPages = ref(3) // 只有3个视频
const audioLabel = computed(() => (isMuted.value ? '取消静音' : '静音'))

// 获取当前页面的视频和图片路径
const currentVideoSrc = computed(() => `/CEOExperience/market/activeIP/page${currentPage.value}.mp4`)
const currentImageSrc = computed(() => `/CEOExperience/market/activeIP/page${currentPage.value}.png`)
