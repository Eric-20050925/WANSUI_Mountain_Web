...
const BACKGROUND_IMAGES = [
  ...
  '/StaffExperience/pause-staff-2.png',
  '/StaffExperience/pause-staff-3.png',
  '/StaffExperience/pause-staff-4.png',
  '/StaffExperience/pause-staff-5.png'
]
const VIDEO_SOURCES = [
  '/StaffExperience/video-1.mp4',
  '/StaffExperience/video-2.mp4',
  '/StaffExperience/video-3.mp4',
  '/StaffExperience/video-4.mp4',
  '/StaffExperience/video-5.mp4'
]
...
const BGM = '/StaffExperience/bgm.mp3'
